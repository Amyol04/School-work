...
public class Driver {
	...
	public static void main(String[] args) {
		...
		System.out.println("Fuel needed to drive the bus 150km" +myBus.fuelNeeded(100)); 
		myBus.display();
		System.out.println("Fuel needed to drive the truck 150km" +myTruck.fuelNeeded(100));
		myTruck.display();
	...
	public static Vehicle efficiencycalculator (Vehicle v1, Vehicle v2) {
        ...
        double distance1 = v1.distanceCoveredKM(1);
        double distance2 = v2.distanceCoveredKM(1);
